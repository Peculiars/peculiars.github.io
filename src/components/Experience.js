        ...
        <div className='xs:my-40 sm:my-64'>
            ...
            <div className='xs:w-[100%] sm:w-[75%] xs:mx-2 sm:mx-auto relative'>
                <ul ref={ref} className='w-full h-full flex flex-col items-start justify-between ml-4'>
                    ...
                    <ExpDetails position='Frontend Developer' company='De-Virtuosphere' href={'https://v1.virtuobusiness.com/'} time='Feb., 2024 - Current' address='Remote' work="Develop and optimize user interfaces for Virtuo's NFC-based solutions, ensuring a seamless and intuitive user experience. Collaborate with backend developers and UI/UX designers to deliver scalable and efficient frontend solutions."/>
                    <ExpDetails position='Frontend Developer Intern' company='NetWalkersNG' href={'https://netwalkers.com.ng/'} time='Aug., 2023 - Jan., 2024' address='Remote' work="Contributed to the development and optimization of the Cowrywise web platform, enhancing user experience and accessibility. Gained hands-on experience in working with APIs, state management, and financial technology solutions."/>
                    <ExpDetails position='Software Developer' company='Cowrywise' href={'https://cowrywise.com/'} time='Jan., 2022 - Jun., 2023' address='Ikeja, GRA, Lagos' work='Participated in an intensive, fast-paced remote internship focused on real-world software development and collaboration. Worked with technologies like React, JavaScript, and CSS to build user-friendly web applications. Completed multiple tasks and projects under strict deadlines.'/>
                </ul>
            </div>
        </div>
  )
